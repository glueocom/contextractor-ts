...
The napi-rs crate is not modified — it continues to output `"txt"` as the format string. Translate at the TypeScript boundary immediately after the native call returns, before the result propagates further.
