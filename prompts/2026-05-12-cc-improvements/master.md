...
- `failed-and-skipped-urls.md` — Dataset records for failed pages + dataset records for skipped links when `storeSkippedUrls: true` (merged from `store-skipped-urls.md`)
