---
name: git:release
description: WHEN cutting a release by bumping the version across all TypeScript and Rust packages, creating a git tag, and pushing. WHEN-NOT for deployment; Apify deploy is a separate step via platform:deploy-and-test.
