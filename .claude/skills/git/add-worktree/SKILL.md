...
description: WHEN creating a git worktree for parallel work on a separate branch. WHEN-NOT for switching branches in the main working tree; use git checkout for that.
