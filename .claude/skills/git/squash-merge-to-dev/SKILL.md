---
name: git:squash-merge-to-dev
description: WHEN squash merging the current feature branch into dev and pushing to remote. WHEN-NOT if already on the dev branch.
