---
name: platform:deploy-and-test
description: WHEN deploying to the Apify test actor by pushing to the dev branch, waiting for build, and running a test crawl. WHEN-NOT for production deploys unless --production is explicitly passed.
