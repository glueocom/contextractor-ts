---
name: meta:setup
description: WHEN auditing, cleaning up, and updating the .claude/ setup — agents, skills, rules, MCP servers, settings. No args for a full audit; pass a path to fix a specific file or folder.
