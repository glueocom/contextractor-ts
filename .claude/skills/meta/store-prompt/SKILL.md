---
name: meta:store-prompt
description: WHEN archiving prompt text or an existing prompt file to the prompts/ directory with exact verbatim content. WHEN-NOT for prompts already in the correct location.
