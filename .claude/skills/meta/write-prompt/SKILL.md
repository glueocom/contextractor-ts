---
name: meta:write-prompt
description: WHEN producing structured implementation, review, and test prompts from a raw prompt idea, with full research scaffold and output in prompts/. WHEN-NOT for quick single-file edits; use meta:write-prompt-file for that.
