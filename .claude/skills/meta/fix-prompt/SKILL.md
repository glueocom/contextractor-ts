---
name: meta:fix-prompt
description: WHEN fixing and compacting a prompt file through deep research on current APIs, best practices, and technical accuracy. WHEN-NOT for structural reformatting; use prompt-formatter agent for that.
