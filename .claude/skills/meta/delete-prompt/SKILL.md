---
name: meta:delete-prompt
description: WHEN deleting an agent, skill, command, or rule and removing all references across the repo. WHEN-NOT if the file may still be in use; always search for references first.
