---
name: autonomous:meta:setup
description: WHEN autonomously auditing and auto-fixing .claude/ setup — frontmatter, stale references, MCP alignment — and saving a report. WHEN-NOT for interactive audits; use meta:setup for those.
