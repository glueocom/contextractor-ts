---
name: autonomous:maintenance:test:apify-platform
description: WHEN deploying to the Apify test actor, running all platform test suites, and updating unit tests from results. WHEN-NOT for local tests; use autonomous:maintenance:test:local for that.
