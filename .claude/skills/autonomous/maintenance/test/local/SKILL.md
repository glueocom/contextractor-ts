---
name: autonomous:maintenance:test:local
description: WHEN building all projects and running local unit tests with auto-fix for lint and format issues. WHEN-NOT for integration or platform tests; those require Apify cloud access.
