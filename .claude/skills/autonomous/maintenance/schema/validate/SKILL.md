---
name: autonomous:maintenance:schema:validate
description: WHEN validating Actor schemas (actor.json, input_schema.json) and running the full build, lint, and test suite. WHEN-NOT for deployment — this is a local validation only.
