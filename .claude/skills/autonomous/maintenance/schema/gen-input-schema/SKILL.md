---
name: autonomous:maintenance:schema:gen-input-schema
description: WHEN regenerating apps/apify-actor/.actor/input_schema.json from the @contextractor/schema Zod 4 source of truth. WHEN-NOT if the Zod schema has not changed.
