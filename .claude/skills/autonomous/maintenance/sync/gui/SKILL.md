---
name: autonomous:maintenance:sync:gui
description: WHEN verifying internal consistency across the TS engine, napi-rs binding, standalone CLI, and Apify schemas, with conservative auto-fix where unambiguous. WHEN-NOT for cross-repo or external sync.
