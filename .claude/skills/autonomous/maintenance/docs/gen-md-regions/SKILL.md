---
name: autonomous:maintenance:docs:gen-md-regions
description: WHEN regenerating all @generated markdown regions in READMEs from the Zod schema and CLI program. WHEN-NOT if the source schema or CLI flags have not changed.
