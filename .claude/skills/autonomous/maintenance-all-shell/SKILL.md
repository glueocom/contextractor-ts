---
name: autonomous:maintenance-all-shell
description: WHEN running the full autonomous maintenance pipeline via shell with an auto-fix loop, iterating until all steps pass or 5 iterations are exhausted. WHEN-NOT for individual maintenance steps; use the specific step skills instead.
