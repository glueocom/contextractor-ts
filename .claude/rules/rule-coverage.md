...
## When running `/meta:setup`

The setup audit must verify that every `.claude/rules/*.md` file is referenced in at least one of the three locations above. Flag any unreferenced rule as a coverage gap requiring wiring.
