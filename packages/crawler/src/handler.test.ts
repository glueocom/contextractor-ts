...
describe("deduplication: 'standard' — canonical dedup across handler calls", () => {
...
describe("deduplication: 'standard' — no canonical tag → content hash inactive", () => {
...
describe("deduplication: 'aggressive' — content hash dedup", () => {
