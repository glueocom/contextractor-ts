...
- Non-zero `EXIT:` code — find which sub-script failed (claude-meta, opencode-meta, claude, opencode)
...
- `dev-utils/autonomous/maintenance/claude.sh`, `opencode.sh`, `claude-meta.sh`, `opencode-meta.sh`
